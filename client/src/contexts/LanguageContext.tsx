...
const translations = {
  ja: {
    ...
    'company.license_value': '新潟県公安委員会 第xxxxxxxxxxxx号',
  ...
  en: {
    ...
    'company.license_value': 'Niigata Public Safety Commission No. xxxxxxxxxxxx',

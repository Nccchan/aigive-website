...
const translations = {
  ja: {
    ...
    'services.buying.desc': '「にこにこ買取」として、X (Twitter) を中心に活動中。古物商許可に基づき、対面・非対面（宅配）での買取を行っております。大切なお品物を丁寧に査定いたします。',
  ...
  en: {
    ...
    'services.buying.desc': 'Operating as "Niko Niko Kaitori", primarily on X (Twitter). Based on our antique dealer license, we offer both in-person and non-face-to-face (mail-in) buying services. We carefully appraise your valuable items.',
